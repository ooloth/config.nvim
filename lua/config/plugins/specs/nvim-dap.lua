...
return {
  ...
  keys = {
    ...
    { '<leader>dfb', function() require('dapui').float_element('breakpoints', {enter=true, position='center', height=1000, width=1000}) end, desc = 'Breakpoints' }, 
    ...
    { '<leader>dfs', function() require('dapui').float_element('stacks', {enter=true, position='center', height=1000, width=1000}) end, desc = 'Stack frames (stacks)' }, 
    ...
    { '<leader>dfw', function() require('dapui').float_element('watches', {enter=true, position='center', height=1000, width=1000}) end, desc = 'Watch expressions' }, 
