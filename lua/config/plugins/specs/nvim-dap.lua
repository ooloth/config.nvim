...
return {
  ...
  keys = {
    ...
    { '<leader>de', function() require('dapui').eval(nil, { enter = true }) end, desc = 'Evaluate', mode = { 'n', 'x' } },
    ...
    { '<leader>dh', function() require('dapui').eval(nil, { enter = true }) end, desc = 'Hover', mode = { 'n', 'x' } },
    ...
    { '<leader>dvc', function() send_selection_to_visidata_in_new_tmux_window('csv') end, desc = 'Visidata (dataframe)', mode={ 'n', 'x' } },
    { '<leader>dvj', function() send_selection_to_visidata_in_new_tmux_window('json') end, desc = 'Visidata (list of dicts)', mode={ 'n', 'x' } },
