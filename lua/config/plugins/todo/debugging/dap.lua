...
return {
  ...
  dependencies = {
    {
      -- TODO: move this spec to its own file and just list the repo name here
    ...
    {
      -- TODO: move this spec to its own file and just include the repo name here
...

    {
      ...
      -- TODO: move this option to which-key.lua and just include the repo name here
      opts = {
        defaults = {
          ['<leader>d'] = { name = 'Debug' },
        },
